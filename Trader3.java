...
public class Trader3 {
    public static void main(String[] args) {
        Trader t1 = new Trader("Akhila", "Pune");
        Trader t2 = new Trader("shashi", "Pune");
        Trader t3 = new Trader("Rachana", "Kammarpally");
        Trader t4 = new Trader("Sarika", "Kalyapur");
        ...
        List<Trader> sortedlist4 = tr.stream().filter(p -> p.getCity().equals("Kalyapur")).sorted(Comparator.comparing(Trader::getName)).collect(Collectors.toList());
        ...
        List<Trader> sortedlist6 = tr.stream().filter(p -> p.getCity().equals("Kalyapur")).collect(Collectors.toList());
