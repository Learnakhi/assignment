...
import java.util.*;
public class GenericEmp1
{

    public static void main(String args[])
    {
        HashSet<Employee<Integer,String,Integer,String>> hashSet = new HashSet<>();
        Employee<Integer,String,Integer,String> e1 =  new Employee<>(1091,"Akhila",18000,"Angular");
        Employee<Integer,String,Integer,String> e2 =  new Employee<>(1092,"Shashi",20000,"ReactJS");
