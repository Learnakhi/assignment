...
public class News2
{
    ...
    {
        News s1=new News(1,"Akhila","Shashi","budget");
        News s2=new News(2,"Shashi","Akhila","good");
        News s3=new News(3,"Akhila","Sarika","excellent");
        News s4=new News(4,"Sarika","Rachana","Stunning");
